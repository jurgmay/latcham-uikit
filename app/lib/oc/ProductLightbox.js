...
function productlightbox() {
	...
	function template() {
		return [
			'<div class="uk-child-width-1-3@m uk-grid-small" uk-grid uk-lightbox="animation: fade">',
			'<div ng-repeat="image in LineItem.images">',
			'<a ng-click="$parent.index=$index" data-type="image" class="uk-inline" href="{{image.url}}" data-caption="">',
